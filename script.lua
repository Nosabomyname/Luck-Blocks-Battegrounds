-- ✅ Lucky Blocks Joãozinho4k (v1.2 com aba Sniffer)    
-- 💡 Funcional no KRNL MOBILE e outros executores  

local lp = game.Players.LocalPlayer    
local pg = lp:WaitForChild("PlayerGui")    

-- Remove GUI antiga caso exista    
...
-- === Aba Sniffer: Sniffer e Scanner de Inventário ===    
...
-- Alterna sniffing e texto do botão    
...
-- Escutar RemoteEvents já existentes    
task.spawn(function()    
...
-- Escutar RemoteEvents criados após o script rodar    
...
-- Escanear inventário de todos os jogadores e mostrar logs    
